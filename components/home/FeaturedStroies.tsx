...
export default function FeaturedStories() {
  ...
  const stories = t("home.featuredStories", { returnObjects: true }) as Array<{
    title: string;
    category: string;
  }>;
  ...
  const images = [
    ...
    "https://images.unsplash.com/photo-1581093588401-22bfc4ab6b79?auto=format&fit=crop&w=1600&q=80",
